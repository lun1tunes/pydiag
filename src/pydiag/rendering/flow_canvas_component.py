    ...
    *,
    ...
    return flow_canvas_component()(
        ...
        default={
            ...
            "pending_node_edits": None,
            "pending_node_create": None,
            "pending_node_creates": None,
            "pending_edge_edit": None,
            "pending_edge_edits": None,
            "pending_process_create": None,
            "pending_process_edit": None,
            "pending_process_delete": None,
            "history_action": None,
        ...
        on_pending_node_edits_change=lambda: None,
        on_pending_node_create_change=lambda: None,
        on_pending_node_creates_change=lambda: None,
        on_pending_edge_edit_change=lambda: None,
        on_pending_edge_edits_change=lambda: None,
        on_pending_process_create_change=lambda: None,
        on_pending_process_edit_change=lambda: None,
        on_pending_process_delete_change=lambda: None,
